...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			...
			'description' => str_replace('%color%', $txt['default_bese_color'], $txt['bese_color_defaulte']),
			'default_value' => $txt['default_bese_color'],
			'type' => 'color',
		),
		array(
			'id' => 'bese_color_primary',
			'label' => $txt['bese_color_primary'],
			'description' => str_replace('%color%', $txt['default_bese_primary'], $txt['bese_color_defaulte']),
			'default_value' => $txt['default_bese_primary'],
			'type' => 'color',
		),
		array(
			'id' => 'bese_color_secondary',
			'label' => $txt['bese_color_secondary'],
			'description' => str_replace('%color%', $txt['default_bese_secondary'], $txt['bese_color_defaulte']),
			'default_value' => $txt['default_bese_secondary'],
			'type' => 'color',
		),
		array(
		...
		'',
		array(
			'id' => 'bese_default_mode',
			'label' => $txt['bese_default_mode'],
			'options' => array(
				0 => $txt['bese_light_mode'],
				1 => $txt['bese_dark_mode'],
				2 => $txt['color_zirzar1'],
			),
			'type' => 'list',
		),
