$(document).on('click', '#cssmenu li.has-sub a span', function(){
	var hrefkaldir = $(this).parent(0);

	if(hrefkaldir.attr('href') != undefined){
		localStorage.setItem('donurl', hrefkaldir.attr('href'));
	}
	
	if(hrefkaldir.attr('href') == undefined && $(this).attr('class') == 'textmenu'){
