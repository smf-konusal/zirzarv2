...
function template_body_above()
{
	...
	<div id="wrapper">';
		...
		echo '
		<div id="logo">
	     	<a id="logos" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="' . $settings['images_url'] . '/theme/logo.png" alt="' . $context['forum_name_html_safe'] . '">' : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name_html_safe'] . '">' ,'</a>
	     	<a class="menu_icon mobile_user_menu"></a>
	     	<div id="siteslogan">', empty($settings['site_slogan']) ? $txt['zirzar_site_slogan'] : $settings['site_slogan'] ,'</div>
	     </div>';
		...
		if($settings['bese_allow_user_modes'] != 0){
...
function template_body_below()
{
	...
	echo '
		<ul>
			...
			<li class="copyright">', theme_copyright().theme_huu(), '</li>
		</ul>';
...
function template_menu()
{
	...
	{
		echo '
						<li class="button_', $act, '', !empty($button['sub_buttons']) ? ' subsections  has-sub"' : '"', '>
							<a', $button['active_button'] ? ' class="active"' : '', ' href="', $button['href'], '"', isset($button['target']) ? ' target="' . $button['target'] . '"' : '', '>
								', $button['icon'], '<span class="textmenu">', $button['title'], !empty($button['amt']) ? ' <span class="amt">' . $button['amt'] . '</span>' : '', '</span>',!empty($button['sub_buttons']) ? '<span class="holder"></span>' : '','
							</a>';
